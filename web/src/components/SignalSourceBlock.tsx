            ...
            <div className="grid grid-cols-2 gap-y-6 gap-x-8">
                <div className="flex flex-col gap-1.5">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <span className="text-sm text-white font-mono font-black uppercase tracking-tight">{source?.platform || 'UNKNOWN'}</span>
                    </div>
                </div>
                ...
                <div className="flex flex-col gap-1.5">
                    ...
                    <div className="flex items-center gap-2 text-[10px] text-slate-400 font-mono bg-slate-950/50 px-2 py-1 rounded border border-slate-800/50">
                        ...
                        {source?.timestamp ? new Date(source.timestamp).toLocaleString() : 'N/A'}
                    </div>
                </div>
